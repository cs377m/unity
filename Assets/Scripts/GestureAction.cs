...
public class GestureAction : MonoBehaviour
{
    ...
    public static Vector3 gesturePosition;
    ...
    void PerformManipulationStart(Vector3 position)
    {
        ...
        Debug.Log("MANIP START POS: " + position.ToString());
    ...
    void PerformManipulationUpdate(Vector3 position)
    {
        if (GestureManager.Instance.IsManipulating)
        {
            ...
            Debug.Log("MANIPULATING POSITION TO: " + position.ToString());
            gesturePosition = position;

            //Console.WriteLine("HEYO OOO " + position.ToString());
